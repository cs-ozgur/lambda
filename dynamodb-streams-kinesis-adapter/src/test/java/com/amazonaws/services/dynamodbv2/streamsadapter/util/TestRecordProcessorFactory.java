...
public class TestRecordProcessorFactory implements IRecordProcessorFactory {
   ...
   */
  public TestRecordProcessorFactory(AWSCredentialsProvider credentials,
    ...
    this.dynamoDB = AmazonDynamoDBClient.builder()
        ...
        .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration(dynamoDBEndpoint, US_EAST_1.getName()))
        .build();
