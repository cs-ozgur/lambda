...
import com.digitalsanctum.lambda.imagebuilder.server.ImageBuilderServer;
import com.digitalsanctum.lambda.imagebuilder.service.DockerImageBuilderTest;
...
public class BuilderServletTest {
  ...
  private ImageBuilderServer imageBuilderServer;
  
  @Before
  public void setup() throws Exception {
    imageBuilderServer = new ImageBuilderServer(TEST_PORT);
    imageBuilderServer.start();
  }
  
  @After 
  public void teardown() throws Exception {
    imageBuilderServer.stop();
  }
