...
public class BaseTest {
  ...
  public static final String TEST_FUNCTION_NAME = "concat";

  protected AWSLambda awsLambda;

  protected String getTestRequest() throws JsonProcessingException {
  ...
  protected void invoke_RequestResponse() throws JsonProcessingException {
