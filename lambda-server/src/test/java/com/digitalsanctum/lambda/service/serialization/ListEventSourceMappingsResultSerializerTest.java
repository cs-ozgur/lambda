 ...
 * @since 3/6/17
 */
public class ListEventSourceMappingsResultSerializerTest {
  ...
  public void testSerialize() throws Exception {
    ...
    result.withEventSourceMappings(
    ...
    String out = awsSdkObjectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(result);
